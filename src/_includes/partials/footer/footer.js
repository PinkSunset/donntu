...
export default new class footer {
	constructor() {
		this.url = 'https://docs.google.com/forms/u/1/d/e/1FAIpQLSeRA6-L2PgusHDEArfk8GI-uSwoZE9Eb2a2TVlGnMJJxnDh1g/formResponse'
		this.handler()
	}
	...
	handler() {
		Alpine.data('feedbackForm', this.feedbackForm)
	}
}
